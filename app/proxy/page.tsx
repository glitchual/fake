        ...
        <div className="glass-panel panel-glow p-6">
          ...
          <div className="mt-6 flex gap-3">
            <input
              ...
              className="flex-1 rounded-lg border border-border/50 bg-card/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/50 focus:border-primary/50 focus:outline-none"
            />
            <button
              onClick={addProxy}
              className="flex items-center gap-2 rounded-lg bg-primary px-5 py-3 font-semibold text-primary-foreground transition-all hover:shadow-[0_0_20px_rgba(200,255,46,0.3)]"
            >
          ...
          {/* Proxy List */}
          <div className="mt-5 rounded-xl border border-border/30 bg-card/30 p-4">
          ...
          <div className="mt-6 flex justify-center">
            <button
              ...
              className="flex items-center gap-2 rounded-full bg-primary px-8 py-3 font-bold text-primary-foreground transition-all hover:shadow-[0_0_25px_rgba(200,255,46,0.4)] disabled:opacity-70"
            >
