...
export default function HelpPage() {
  ...
  return (
    <div className="relative flex h-screen flex-col overflow-hidden bg-background select-none">
      ...
      {/* Content Area */}
      <div className="relative z-10 flex flex-1 justify-center overflow-hidden px-6 py-4 lg:px-8">
        <div className="flex h-full max-h-[600px] w-full max-w-[1180px] gap-4">
          ...
          {/* Center content */}
          <main className="page-enter glass-panel panel-glow flex flex-1 flex-col overflow-hidden p-5">
            {/* Header */}
      ...
      <footer className="relative z-10 border-t border-border/20 bg-card/40 backdrop-blur-sm">
        <div className="mx-auto flex h-12 max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <p className="max-w-[220px] text-xs leading-tight text-muted-foreground/60">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="max-w-[240px] text-xs leading-tight text-muted-foreground/60">
